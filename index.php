...
<body>
  ...
  <h3 class="text-center">Welcome to AJAX PHP CRUD Function!</h3>
    ...
    <div class="row">
      <div class="container">
        <div class="btnAdd">
          <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-success btn-sm">Enlist</a>
        </div>
        <div class="row">
  ...
  <script type="text/javascript" src="js/datatables-1.10.25.min.js"></script>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="emailField" class="col-md-3 form-label">Email Ad</label>
              <div class="col-md-9">
                <input type="email" class="form-control" id="emailField" name="email">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="mobileField" class="col-md-3 form-label">Mobile Number </label>
              <div class="col-md-9">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            ...
            <div class="mb-3 row">
              <label for="addEmailField" class="col-md-3 form-label">Email Ad</label>
              <div class="col-md-9">
                <input type="email" class="form-control" id="addEmailField" name="email">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="addMobileField" class="col-md-3 form-label">Mobile Number</label>
              <div class="col-md-9">
